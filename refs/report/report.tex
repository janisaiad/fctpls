...
\]
where $U$ is the tail quantile function of $Y$, defined by $U(t) = F^{-1}(1-1/t)$, with $F$ the cumulative distribution function of $Y$. In practice, $y_{n,k}$ is approximated by the $(n-k+1)$-th order statistic $Y_{n-k+1,n}$:
\[
